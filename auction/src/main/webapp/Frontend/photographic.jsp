...
<body>
	...
	<div class="container">
		...
		<div class="col-md-7" style="margin-top: 30px;">
			...
			<h3 style="color: #2f0f5e;">Photographic-image Listing.</h3>
			
				<div class="row" style="margin-top: 30px;">
					<div class="col-md-7">
						<img alt="" src="../images/black&white-image.jpg" width="400px;">
					</div>
					<div class="col-md-1 offset-md-1"></div>
					<div class="col-md-3" style="margin-top: 20px;">						
						Artist Name: xxx <br> Image-type: black&white <br>
					</div>
				</div>
				<div class="row" style="margin-top: 30px;">
					<div class="col-md-7">
						<img alt="" src="../images/color-image.jpg" width="400px;">
					</div>
					<div class="col-md-1 offset-md-1"></div>
					<div class="col-md-3" style="margin-top: 20px;">						
						Artist Name: xxx <br> Image-type: color <br>
					</div>
				</div>
		</div>
		</div>
