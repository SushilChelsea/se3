...
<body>
	...
	<div class="container">
		...
		<div class="col-md-7" style="margin-top: 30px;">
			...
			<h3 style="color: #2f0f5e;" >Carvings Listing.</h3>
			
				<div class="row" style="margin-top: 30px;">
					<div class="col-md-7">
						<img alt="" src="../images/oak-carving.jpg" width="400px;">
					</div>
					<div class="col-md-1 offset-md-1"></div>
					<div class="col-md-3" style="margin-top: 20px;">						
						Artist Name: xxx <br> Material-Used: Oak <br>
					</div>
				</div>
				<div class="row" style="margin-top: 30px;">
					<div class="col-md-7">
						<img alt="" src="../images/pine-carving.jpg" width="400px;">
					</div>
					<div class="col-md-1 offset-md-1"></div>
					<div class="col-md-3" style="margin-top: 20px;">						
						Artist Name: xxx <br> Material-Used: Pine <br>
					</div>
				</div>
		</div>
		</div>
